...
function camelToKebabCase(e){if(null==e)return e;for(var n="",l=0,t=void 0,o=String(e),a=0;a<o.length;a++){var r=o[a],g=r.toLowerCase();if(r!==g){var i=n[n.length-1];1<l&&1<n.length&&(n=n.slice(0,n.length-2)+i),n.length&&"-"!==i&&" "!==i&&"\t"!==i&&"\r"!==i&&"\n"!==i&&(n+="-"),n+=r.toLowerCase(),l++,t=!1}else"0"===r||"1"===r||"2"===r||"3"===r||"4"===r||"5"===r||"6"===r||"7"===r||"8"===r||"9"===r?(!1===t&&"-"!==n[n.length-1]&&(n+="-"),n+=r,t=!(l=0)):(t&&"-"!==n[n.length-1]?n+="-"+r:n+=r,l=0,t=!1)}return 1<l&&1<n.length&&(n=n.slice(0,n.length-2)+n[n.length-1]),n}"undefined"!=typeof module&&(module.exports=camelToKebabCase),"undefined"!=typeof window&&(window.camelToKebabCase=camelToKebabCase);
